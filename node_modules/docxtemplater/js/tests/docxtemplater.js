...
var fileNames = ["angularExample.docx", "cyrillic.docx", "imageExample.docx", "oneRawXMLTag.docx", "tableComplex2Example.docx", "tableComplexExample.docx", "tagDashLoop.docx", "tagDashLoopList.docx", "tagDashLoopTable.docx", "tagExample.docx", "tagExampleExpected.docx", "tagIntelligentLoopTable.docx", "tagIntelligentLoopTableExpected.docx", "tagLoopExample.docx", "tagProduitLoop.docx", "simpleExample.pptx", "rawXmlExample.pptx", "image.png"];
...
function startTest() {
	...
	describe("Raw Xml Insertion", function () {
		...
		it("should work with simple example and given options", function () {
			...
			var doc = new Docxtemplater(docX["oneRawXMLTag.docx"].loadedContent);
			doc.setOptions({
